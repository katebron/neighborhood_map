    ...
    return (0, _mapStream2.default)(function (file, callback) {
        ...
        new _bluebird2.default(function (resolve, reject) {
            ...
            if (jsdocConfig.source && jsdocConfig.source.include) {
                jsdocConfig.source.include = jsdocConfig.source.include.concat(files);
            } else {
            ...
            _fs2.default.writeFile(tmpobj.name, JSON.stringify(jsdocConfig), 'utf8', function (err) {
                ...
                if (!(jsdocConfig.opts && jsdocConfig.opts.template) && !(jsdocConfig.templates && jsdocConfig.templates.default && jsdocConfig.templates.default.layoutFile)) {
                ...
                child.on('close', function (code) {
                    if (code === 0) {
                        _gulpUtil2.default.log('Documented ' + jsdocConfig.source.include.length + ' files!');
                        resolve();
                    } else {
